...
public class WaldService
{
    ...
    private string console_log = string.Empty;
    ...
    public void GetCouponInfo()
    {
        ...
        WaltDll.GetCouponInfo(ShopCode, exist_coupon_queue.Peek(), products.ToArray(), products.Count, GetCouponInfoResult);
    }
    ...
    {
        console_log = $"SaveStampResult: {result}, {result_msg}, reward_stamp : {reward_stamp}, stamp_count : {stamp_count}, coupon_issue : {coupon_issue}, reward_id : {reward_id}";
    ...
    {
        console_log = $"CancelStampResult: {result}, {result_msg}, cancel_stamp: {cancel_stamp}, stamp_count : {stamp_count}";
        if (result == true)
        {
    ...
    {
        console_log = $"UseCouponResult: {result}, {result_msg}, product_code : {product_code}, coupon_id : {coupon_id}, type : {type}, amount : {amount}, is_total : {is_total}";
    ...
    {
        console_log = $"CancelCouponResult: {result}, {result_msg}";
        if (result == true)
        {
    ...
    {
        console_log = $"GetCouponInfoResult: {result}, {result_msg}, type : {type}, amount : {amount}, item_code : {item_code}, is_total : {is_total}";
    }

    public void SavePointResult(bool result, string result_msg, int reward_point, int total_point, string reward_id)
    {
        console_log = $"SavePointResult: {result}, {result_msg}, reward_point : {reward_point}, total_point : {total_point}, reward_id : {reward_id}";
        if (result == true)
        {
    ...
    {
        console_log = $"CancelPointResult: {result}, {result_msg}, cancel_point : {cancel_point}, total_point : {total_point}";
        if (result == true)
        {
    ...
    {
        console_log = $"UsePointResult: {result}, {result_msg}, use_id : {use_id}, use_point : {use_point}, total_point : {total_point}";
    ...
    {
        console_log = $"CancelUsePointResult: {result}, {result_msg}, return_point : {return_point}, total_point : {total_point}";
